...
// --- FIX #1: Import pdf2pic instead of poppler ---
...
const processClaimJob = async (job) => {
  ...
  let finalImagePath = null; // Define here to access in finally block
  ...
  try {
    ...
    finalImagePath = conversionResult.path; // Assign path to the variable
    // --- END OF REPLACEMENT ---
